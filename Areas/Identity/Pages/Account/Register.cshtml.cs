...
namespace Company.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new Employee { UserName = Input.Email, Email = Input.Email, StartWork = DateTime.Now, DOB = Input.DOB, FullName = Input.FullName };
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email",
                        _emailComposer.ComposeConfirmEmail(user.FullName, HtmlEncoder.Default.Encode(callbackUrl)));
